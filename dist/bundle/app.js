...
function () {
  ...
  ProductInfoService.prototype.initializeInstallers = function () {
    var title = 'zibbit';
    var installer1 = this.getInstaller(title, '2.0.2.0'); //new Installer(title + "_v" + version, version, url);
